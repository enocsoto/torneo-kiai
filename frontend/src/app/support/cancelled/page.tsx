  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-[var(--background)] px-4 text-[var(--foreground)] transition-colors duration-200">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
        <div className="absolute left-1/2 top-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-orange-500/[0.07] blur-3xl dark:bg-orange-600/8" />
      </div>

      <div className="relative z-10 flex max-w-sm flex-col items-center gap-6 text-center">
        <div className="flex size-20 items-center justify-center rounded-full border border-[var(--border-subtle)] bg-[var(--chip-surface)] ring-1 ring-[var(--border-muted)]/50 dark:bg-white/5 dark:ring-white/10">
          <span className="text-4xl leading-none" role="img" aria-hidden>💬</span>
        </div>

        <div className="space-y-2">
          <h1 className="text-2xl font-semibold tracking-tight text-[var(--foreground)]">
            {t("support.cancelTitle")}
          </h1>
          <p className="text-sm leading-relaxed text-[var(--muted)]">
            {t("support.cancelLine")}
          </p>
        </div>
